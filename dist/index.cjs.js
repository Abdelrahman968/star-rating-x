...
const StarRating = /*#__PURE__*/React.forwardRef(function StarRating({
  ...
  // ── undo last rating ──────────────────────────────────────────────────────
  const [undoPrev, setUndoPrev] = React.useState(null);
  ...
  if (loading) {
    return /*#__PURE__*/jsxRuntime.jsx("span", {
      ...
      children: Array.from({
        length: count
      }, (_, i) => /*#__PURE__*/jsxRuntime.jsx("span", {
        style: {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("span", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("svg", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("defs", {
        ...
        }, i)), filledGradient && filledGradient.length >= 2 && /*#__PURE__*/jsxRuntime.jsx("linearGradient", {
          id: gradId,
          x1: gx1,
          y1: gy1,
          x2: gx2,
          y2: gy2,
          children: filledGradient.map((color, i) => /*#__PURE__*/jsxRuntime.jsx("stop", {
            offset: `${i / (filledGradient.length - 1) * 100}%`,
            stopColor: color
          }, i))
        })]
      })
    }), showConfetti && /*#__PURE__*/jsxRuntime.jsx("span", {
      "aria-hidden": true,
      style: {
        position: "absolute",
        top: "50%",
    ...
    }), compareValue !== undefined && /*#__PURE__*/jsxRuntime.jsx("span", {
      "aria-hidden": true,
      style: {
        position: "absolute",
        left: 0,
    ...
    }), compareValue !== undefined && /*#__PURE__*/jsxRuntime.jsxs("span", {
      "aria-hidden": true,
      style: {
        marginLeft: 6,
    ...
    }), allowUndo && undoVisible && undoPrev !== null && /*#__PURE__*/jsxRuntime.jsxs("span", {
      "aria-live": "polite",
      style: {
        position: "absolute",
        bottom: "calc(100% + 8px)",
...
const RatingDistribution = /*#__PURE__*/React.forwardRef(function RatingDistribution({
  data = {},
  total: totalOverride,
  count = 5,
  theme = "gold",
  ...
  const computedAvg = React.useMemo(() => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [!compact && total > 0 && /*#__PURE__*/jsxRuntime.jsxs("div", {
      style: {
        display: "flex",
        alignItems: "baseline",
        gap: 8,
      ...
      return /*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs("span", {
          ...
          children: [star, /*#__PURE__*/jsxRuntime.jsx("svg", {
            viewBox: "0 0 24 24",
            width: sz,
            height: sz,
            children: /*#__PURE__*/jsxRuntime.jsx("path", {
...
const StarRatingInput = /*#__PURE__*/React.forwardRef(function StarRatingInput({
  // form
  name,
  label,
  required = false,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [label && /*#__PURE__*/jsxRuntime.jsxs("label", {
      ...
      "aria-hidden": true,
      readOnly: true
    }), hasError && /*#__PURE__*/jsxRuntime.jsxs("span", {
      id: `${id}-error`,
      role: "alert",
      style: {
        fontSize: 12,
    ...
    }), !hasError && helperText && /*#__PURE__*/jsxRuntime.jsx("span", {
      id: `${id}-helper`,
      style: {
        fontSize: 12,
        color: "#64748b",
...
const StarRatingTooltip = /*#__PURE__*/React.forwardRef(function StarRatingTooltip({
  value: controlledValue,
  defaultValue = 0,
  count = 5,
  precision = 1,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("span", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("svg", {
    ...
    }), hoverIndex !== null && tooltipLabel && /*#__PURE__*/jsxRuntime.jsxs("div", {
      "aria-hidden": true,
      style: {
        position: "absolute",
      ...
      children: [tooltipRenderer ? tooltipRenderer({
        ...
        label: tooltipLabel,
        index: hoverIndex
      }) : tooltipLabel, /*#__PURE__*/jsxRuntime.jsx("span", {
        style: {
          position: "absolute",
      ...
      return /*#__PURE__*/jsxRuntime.jsxs("span", {
        ...
        children: [isSelected && /*#__PURE__*/jsxRuntime.jsx("span", {
          style: {
            position: "absolute",
            inset: -3,
            borderRadius: "50%",
...
const RatingBadge = /*#__PURE__*/React.forwardRef(function RatingBadge({
  value = 0,
  count,
  max = 5,
  theme = "gold",
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("span", {
    ...
    children: [showStar && /*#__PURE__*/jsxRuntime.jsx("svg", {
      viewBox: "0 0 24 24",
      width: s.starSize,
      height: s.starSize,
      "aria-hidden": true,
    ...
    }), !compact && showCount && count !== undefined && /*#__PURE__*/jsxRuntime.jsxs("span", {
      style: {
        color: color,
        opacity: 0.6,
...
const RatingSummary = /*#__PURE__*/React.forwardRef(function RatingSummary({
  average = 0,
  total = 0,
  distribution = {},
  reviews = [],
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        }), total > 0 && /*#__PURE__*/jsxRuntime.jsxs("div", {
          style: {
            marginTop: 4,
            fontSize: 11,
            color: "#94a3b8",
      ...
      }), showDistribution && Object.keys(distribution).length > 0 && /*#__PURE__*/jsxRuntime.jsx("div", {
        style: {
          flex: 1,
          minWidth: 160
        },
        children: /*#__PURE__*/jsxRuntime.jsx(RatingDistribution, {
          data: distribution,
          total: total,
          theme: theme,
          filledColor: filledColor,
    ...
    }), onWriteReview && /*#__PURE__*/jsxRuntime.jsx("button", {
    ...
    }), showReviews && reviews.length > 0 && /*#__PURE__*/jsxRuntime.jsx("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 12,
      ...
      children: reviews.slice(0, maxReviews).map((r, i) => /*#__PURE__*/jsxRuntime.jsxs("div", {
        style: {
          padding: "14px 16px",
          borderRadius: 12,
          background: "#0f172a",
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
          ...
          children: [r.avatar ? /*#__PURE__*/jsxRuntime.jsx("img", {
            src: r.avatar,
            alt: r.author,
            style: {
              width: 32,
            ...
            children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
              ...
              }), r.verified && /*#__PURE__*/jsxRuntime.jsx("span", {
                style: {
                  fontSize: 10,
                  fontWeight: 700,
                  color: "#34d399",
        ...
        }), r.title && /*#__PURE__*/jsxRuntime.jsx("p", {
          style: {
            margin: 0,
            fontSize: 13,
            fontWeight: 700,
          ...
          children: r.title
        }), r.text && /*#__PURE__*/jsxRuntime.jsx("p", {
          style: {
            margin: 0,
            fontSize: 13,
            color: "#94a3b8",
...
const RatingWall = /*#__PURE__*/React.forwardRef(function RatingWall({
  reviews = [],
  columns = 3,
  maxItems = 9,
  showMore = true,
  ...
  const t = getThemeVars(theme);
  const color = filledColor || t.filled;
  const [visible, setVisible] = React.useState(maxItems);
  const [helpfulIds, setHelpfulIds] = React.useState(new Set());
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: shown.map((review, i) => /*#__PURE__*/jsxRuntime.jsx(ReviewCard, {
        review: review,
        color: color,
        theme: theme,
        filledColor: filledColor,
    ...
    }), showMore && visible < filtered.length && /*#__PURE__*/jsxRuntime.jsx("div", {
      style: {
        textAlign: "center",
        marginTop: 24
      },
...
function ReviewCard({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [review.avatar ? /*#__PURE__*/jsxRuntime.jsx("img", {
        src: review.avatar,
        alt: review.author,
        style: {
          width: 36,
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
          ...
          }), review.verified && /*#__PURE__*/jsxRuntime.jsx("span", {
            style: {
              fontSize: 9,
              fontWeight: 700,
              color: "#34d399",
    ...
    }), review.title && /*#__PURE__*/jsxRuntime.jsx("p", {
      style: {
        margin: 0,
        fontSize: 13,
        fontWeight: 700,
    ...
    }), review.text && /*#__PURE__*/jsxRuntime.jsx("p", {
      style: {
        margin: 0,
        fontSize: 12,
        color: "#94a3b8",
    ...
    }), onHelpful && /*#__PURE__*/jsxRuntime.jsx("button", {
      onClick: onHelpful,
      disabled: isHelpful,
      style: {
        alignSelf: "flex-start",
...
const RatingPrompt = /*#__PURE__*/React.forwardRef(function RatingPrompt({
  trigger = "time",
  delay = 5000,
  scrollPercent = 60,
    ...
    jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx("p", {
          ...
          children: message
        }), subMessage && /*#__PURE__*/jsxRuntime.jsx("p", {
          style: {
            margin: "4px 0 0",
            fontSize: 12,
            color: "#64748b"
        ...
        }), showLater && /*#__PURE__*/jsxRuntime.jsx("button", {
          onClick: handleLater,
          style: {
            padding: "9px 14px",
            borderRadius: 10,
...
function useRatingField({
  ...
  const runValidation = React.useCallback(val => {
  ...
  const revalidate = React.useCallback(() => runValidation(value), [runValidation, value]);
...
exports.StarRatingTooltip = StarRatingTooltip;
...
exports.useRatingAnalytics = useRatingAnalytics;
exports.useRatingExport = useRatingExport;
exports.useRatingField = useRatingField;
exports.useRatingGroupAnalytics = useRatingGroupAnalytics;
exports.useRatingPersistence = useRatingPersistence;
